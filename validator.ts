...
export class PatternValidator {
    ...
    private static validateRegex(pattern: Pattern, result: ValidationResult): void {
        if (!pattern.regex?.pattern) return;
    ...
    private static analyzePerformance(pattern: Pattern, result: ValidationResult): void {
        if (!pattern.regex?.pattern) return;
    ...
    private static analyzeSecurityImplications(pattern: Pattern, result: ValidationResult): void {
        if (!pattern.regex?.pattern) return;
    ...
    private static validateTestData(pattern: Pattern, result: ValidationResult): void {
